...
const SecondSection = () => {
  return (
    <section className="py-10 space-x-10 space-y-4 flex items-center justify-center flex-col">
      <div className="text-5xl">Why Bird ?</div>
      <div className="text-2xl text-center">
        According to JDA, Bird improves employee productivity by 45%.
      </div>
      <div className="md:flex space-y-10 md:space-y-0 md:space-x-10 text-xl">
